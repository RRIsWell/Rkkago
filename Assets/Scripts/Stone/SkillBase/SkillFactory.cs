        ...
        foreach (var so in datas.SkillSO)
        {
            switch (so.skillName)
            {
                ...
                case SkillName.Teleportation:
                    ...
                    break;
                case SkillName.KingShield:
                    skills.Add(SkillName.KingShield, new KingShield(stone, so));
                    break;
                ...
                case SkillName.ShadowPartner:
                    ...
                    break;
                case SkillName.LateBloomer:
                    skills.Add(SkillName.LateBloomer, new LateBloomer(stone, so));
                    break;
